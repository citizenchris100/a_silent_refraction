extends Node2D
class_name NavigationOscillationComponentTest
# Navigation Oscillation Component Test: Tests the integration between player movement, navigation, and walkable area boundary systems
...
func _ready():
	debug_log("Setting up Navigation Oscillation component test...")
